...
public:
    static bool         GetUserInfo(const int64 &uid, std::string& dist);
    static bool         UpdateUserInfo(const int64 &uid,std::string& dist);
	...
	static bool         GetRankInfo(int rank_id,std::string& dist);
	static bool         UpdateRankInfo(int rank_id,std::string dist);
public:
