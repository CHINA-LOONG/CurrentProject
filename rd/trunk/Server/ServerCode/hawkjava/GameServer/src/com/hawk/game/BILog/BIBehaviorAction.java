...
public class BIBehaviorAction {
	...
	public static enum Action {
		 ...
		 * 转让会长
		 */
		GUILD_MAIN_TRANSFER(10004),
		/**
		 * 任命副会长
		 */
		GUILD_COPY_MAIN_ADD(10005),
		/**
		 * 解除副会长
		 */
		GUILD_COPY_MAIN_REMOVE(10006),
		/**
		 * 请离公会
		 */
		GUILD_KICK(10007),
		 ...
		 * 公会任务奖励
		 */
		GUILD_TASK_REWARD(10009),
		/**
		 * 公会任务开启
		 */
		GUILD_TASK_OPEN(10010),
		/**
		 * 公会任务放弃返还
		 */
		GUILD_TASK_GIVEUP(10011),
		/**
		 * 公会科技
		 */
		GUILD_TECH_LEVELUP(10012),
		/**
		 * 公会每日贡献奖励
		 */
		GUILD_CONTRIBUTION_REWARD(10013),
		/**
		 * 公会基地助战
		 */
