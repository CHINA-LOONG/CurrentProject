...
namespace Funplus{
	...
	public class FunplusError {
		private EFunplusErrorCode mErrorCode;
		private string mErrorMsg;
		private string mLocalizedMsg;

		public enum EFunplusErrorCode{
			...
			FPErrorFailedLoginAccount               = 1205, //delete
			FPErrorAccountBindedToOther             = 1206, //delete
			...
			// Facebook错误（21xx）
			//FPErrorFacebookNotLogin                 = 2100, //delete
			...
			FPErrorVkAccessDenied                   = 2203, //Vk id has bind to another fpid
		...
		public FunplusError(EFunplusErrorCode aCode, string aMsg, string aLocMsg) {
			this.mErrorCode = aCode;
			this.mErrorMsg = aMsg;
			this.mLocalizedMsg = aLocMsg;
		}

		public EFunplusErrorCode getErrorCode() {
			return mErrorCode;
		}
