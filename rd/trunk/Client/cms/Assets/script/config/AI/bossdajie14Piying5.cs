...
public class bossdajie14Piying5 : BossAi {
	...
	public override BattleUnitAi.AiAttackResult GetAiAttackResult(GameUnit Piying5Unit)
	{
		...
		if (NormalScript.GetWpLifeLeft(Piying5Unit.battleUnit, "bossdajie14Piying5wp02") != 0 && NormalScript.GetWpLifeLeft(Piying5Unit.battleUnit, "bossdajie14Piying5wp03") != 0 )
		{
		...
		else if (NormalScript.GetWpLifeLeft(Piying5Unit.battleUnit, "bossdajie14Piying5wp02") == 0 && NormalScript.GetWpLifeLeft(Piying5Unit.battleUnit, "bossdajie14Piying5wp03") != 0 )
		{
			if (GetAttackCount(Piying5Unit) % 6 == 0 && GetAttackCount(Piying5Unit) != 0) 
			{
				Piying5SpellDic.TryGetValue ("bossdajie14Piying54", out useSpell);
	...
	public override void OnWpDead(WeakPointDeadArgs args)
	{
		...
		if (args.wpID == "bossdajie14Piying5wp02")
		{
			target.TriggerEvent("piying5_wp02dead", Time.time, null);
		}
		if (args.wpID == "bossdajie14Piying5wp03")
		{
			target.TriggerEvent("piying5_wp03dead", Time.time, null);
		}
	}
	//---------------------------------------------------------------------------------------------
}
