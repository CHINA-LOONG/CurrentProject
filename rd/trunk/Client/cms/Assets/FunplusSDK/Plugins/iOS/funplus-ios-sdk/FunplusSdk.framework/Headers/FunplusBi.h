...
- (void) traceRawEvent:(NSDictionary*) properties;
...
- (void) onPayment:(NSString*) productId orderId:(NSString*) orderId throughCargo:(NSString*) throughCargo purchaseData:(NSDictionary*) purchaseData;
