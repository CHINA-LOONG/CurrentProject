...
typedef enum{
    ...
    FPErrorWechatFailedToServer             = 2006,
    FPErrorWechatException                  = 2007,
    FPErrorWechatGetFriendsDataFailed       = 2008,
    ...
    // BI error
    FPErrorBiNoSuchEvent                    = 4000,
    FPEventPropertiesNotValid               = 4001,
} FunplusErrorCode;
