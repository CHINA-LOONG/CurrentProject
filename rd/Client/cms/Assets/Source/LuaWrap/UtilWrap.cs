...
public class UtilWrap
{
	public static LuaMethod[] regs = new LuaMethod[]
	{
		...
		new LuaMethod("UnZipFromBytes", UnZipFromBytes),
	...
	{
		new LuaField("BuildPath", get_BuildPath, null),
		new LuaField("ResPath", get_ResPath, null),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_BuildPath(IntPtr L)
	{
		LuaScriptMgr.Push(L, Util.BuildPath);
		return 1;
	}
	...
	{
		LuaScriptMgr.Push(L, Util.ResPath);
		return 1;
	}
	...
	{
		LuaScriptMgr.Push(L, Util.AssetBundlePath);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int UnZipFromBytes(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		byte[] objs0 = LuaScriptMgr.GetArrayNumber<byte>(L, 1);
		string arg1 = LuaScriptMgr.GetLuaString(L, 2);
		Util.UnZipFromBytes(objs0,arg1);
		return 0;
	}
