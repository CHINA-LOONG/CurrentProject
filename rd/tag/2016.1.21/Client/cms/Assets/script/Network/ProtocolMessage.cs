...
public class ProtocolMessage  
{
	...
	public static ProtocolMessage Create(int type)
	{
		ProtocolMessage protocol = Create();
		protocol.SetMessageType (type);
		return protocol;
	}
	
	public static ProtocolMessage Create(int type, ProtoBuf.IExtensible builder)
	{
		ProtocolMessage protocol = Create(type);
		try
		{
	...
	protected ProtocolMessage(int type)
	{
	...
	public ProtocolMessage SetMessageType(int type)
	{
		if (header != null)
		{
			header.type = type;
